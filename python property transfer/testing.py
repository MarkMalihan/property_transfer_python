...
home = ImageTk.PhotoImage(Image.open('python property transfer\images\icons8-transfer-48.png').resize((40,40),Image.ANTIALIAS))
settings = ImageTk.PhotoImage(Image.open('python property transfer\images\icons8-transfer-48.png').resize((40,40),Image.ANTIALIAS))
ring = ImageTk.PhotoImage(Image.open('python property transfer\images\icons8-transfer-48.png').resize((40,40),Image.ANTIALIAS))
